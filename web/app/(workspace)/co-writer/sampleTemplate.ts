...
export const CO_WRITER_SAMPLE_TEMPLATE = `# EduMind Co-Writer

> EduMind's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for EduMind product docs and learning content

## Headers (Underline)

EduMind Learning Note
=============

EduMind Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers EduMind while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> EduMind helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [EduMind](#deeptutor-co-writer)

### Links

[EduMind Co-Writer](#deeptutor-co-writer "co-writer section")

[EduMind Learning Note](#deeptutor-learning-note)

[EduMind Website](https://deeptutor.info)
...
- [x] Draft a EduMind product note
...
op=>operation: EduMind analyzes intent
...
${FENCE}seq
Student->EduMind: Ask for help
EduMind->KnowledgeBase: Load context
Note right of EduMind: Collect memory\\nand relevant knowledge
EduMind-->Student: Return guided response
Student->>EduMind: Request rewrite in co-writer
${FENCE}
